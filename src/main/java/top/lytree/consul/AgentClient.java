...
import top.lytree.consul.option.ImmutableQueryOptions;
import top.lytree.consul.option.QueryOptions;
import top.lytree.consul.option.QueryParameterOptions;
...
public class AgentClient extends BaseClient {
    ...
    /**
     * Registers the client as a service with Consul with an existing {@link top.lytree.consul.model.agent.Registration.RegCheck}
     *
     * @param port  The public facing port of the service to register with Consul.
     ...
     * @param queryOptions The Query Options to use.
     * @return A {@link top.lytree.consul.model.ConsulResponse} containing {@link FullService} object.
     */
